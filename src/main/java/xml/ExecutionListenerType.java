...
/**
 * <p>Java-Klasse für ExecutionListenerType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="ExecutionListenerType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ExecutionListenerType", namespace = "http://camunda.org/schema/1.0/bpmn", propOrder = {
    "fields"
})
public class ExecutionListenerType
