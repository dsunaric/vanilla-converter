    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "correlationPropertyBinding", namespace = "http://www.omg.org/spec/BPMN/20100524/MODEL", type = CorrelationPropertyBinding.class, required = false)
