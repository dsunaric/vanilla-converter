...
/**
 * <p>Java-Klasse für TaskDefinition complex type.
 * 
...
@XmlType(name = "TaskDefinition", namespace = "http://camunda.org/schema/zeebe/1.0")
@XmlRootElement(name = "taskDefinition", namespace = "http://camunda.org/schema/zeebe/1.0")
