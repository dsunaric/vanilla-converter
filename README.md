...
| BPMN Element      | Camunda 7 Element            | Description                | Camunda7XMLRepresentation                                                                                                                                                                  | Mapped to(C8)                                                                                                                                                                            |
|-------------------|------------------------------|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Parallel Multi Instance   | MultiInstanceLoopCharacteristics embedded in Task | Mapped to zeebee:loopcharacteristics | `<bpmn:multiInstanceLoopCharacteristics camunda:asyncBefore="true" camunda:collection="${collection}" camunda:elementVariable="${element}"  isSequential="false" />` | `<bpmn:multiInstanceLoopCharacteristics isSequential=" false">    <br>   <bpmn:extensionElements><br>          <zeebe:loopCharacteristics inputCollection="= collecion" inputElement="element" /><br>        </bpmn:extensionElements><br>      </bpmn:multiInstanceLoopCharacteristics>` |
| Sequencial Multi Instance | MultiInstanceLoopCharacteristics embedded in Task | Mapped to zeebee:loopcharacteristics | `<bpmn:multiInstanceLoopCharacteristics camunda:asyncBefore="true" camunda:collection="${collection}" camunda:elementVariable="${element}"  isSequential="true" />`  | `<bpmn:multiInstanceLoopCharacteristics isSequential=" true">    <br>   <bpmn:extensionElements><br>          <zeebe:loopCharacteristics inputCollection="= collecion" inputElement="element" /><br>        </bpmn:extensionElements><br>      </bpmn:multiInstanceLoopCharacteristics>`  |
...
### Task Markers
Ad-Hoc and Loop Task Markers are not supported by Camunda 8